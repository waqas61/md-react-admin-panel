...
const ReferralModal = ({ isOpen, onClose, successModal, errorModal, getReferrals, setSuccessMessage }) => {
  ...
  const schema = Yup.object().shape({
    ...
    // email: Yup.string().email("Email Format is not correct"),
                      ...
                      >
                        <Stack sx={{ width: '100%', px: 1, pt: 1 }} spacing={2}>
                          ...
                          >
                            ...
                            <br />
                            Please note this professional is already in our system. No referral gift will be awarded.
                          </Alert>
                        </Stack>
                      </Grid>
                    )}

                    <Box sx={{ flexGrow: 7, py: 5 }}>
                      <Grid container >
                        <Grid item xs={8}>  </Grid>
                        <Grid item xs={4}>
                          <LoadingButton
