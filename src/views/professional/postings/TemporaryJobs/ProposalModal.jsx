...
const ProposalModal = ({ isOpen, onClose, item, setOpenSuccessModal, setSuccessMessage, fetchData }) => {
  ...
  const AcceptProposal = () => {
    axios.put(
      `https://api.mddentalstaffing.com/api/v1/proposal/${item.id}/accept`,
      {
        proposal_id: item.id,
      },
      {
  ...
  const DeclineProposal = () => {
    axios.put(
      `https://api.mddentalstaffing.com/api/v1/proposal/${item.id}/decline`,
      {
        proposal_id: item.id,
                      ...
                      return (
                        <>
                          <Grid item xs={12}>
                            ...
                            {'   '}
                            {moment(sch.start_time, 'HH:mm:ss').utc().format("MM/DD/YY hh:mm A")}
                            {'  -  '}
                            {moment(sch.end_time, 'HH:mm:ss').utc().format("MM/DD/YY hh:mm A")}
                          </Grid>
                        </>
                      );
                    })}
