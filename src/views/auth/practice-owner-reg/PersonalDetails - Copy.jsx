...
export default function PersonalDetails({ setActiveStep }) {
  ...
  return (
    <div>
      ...
      <form className="w-100 w-lg-75 mx-auto" onSubmit={handleNext}>
        <Row>
          {/* First Column */}
          <Col xs={12} md={3} className="p-0 p-md-2 pe-0 pe-2">
        ...
        <Row className="my-0 my-md-4">
          <Col className="mt-3 mt-md-0 ps-2" xs={12} md={1}>
            <Button
              variant="outlined"
              color="primary"
              style={{ height: "2.5rem", width: "100%" }}
          ...
          <Col className="my-3 my-md-0 ps-2" xs={12} md={2}>
            <Button
              type="submit"
              variant="contained"
              style={{ height: "2.5rem", width: "100%" }}
