...
export default function ForSpecialist({
  setAdditionalInfo,
  additionalInfo,
  setSpecialties,
  specialties,
    ...
    <>
        ...
        <Grid container spacing={3}>
          ...
          >
            <Grid container spacing={1}>
              ...
              >
                {/* <h6 style={{ color: "#595959" }}>
                  How many years/months as an DDS?
                </h6> */}
                <Typography variant="h6" sx={{ color: "#595959", mt: 1, mb: 1 }}>
                  How many years/months as an DDS?
                </Typography>
      ...
      {/* <Row style={{ width: '95%' }}>
        ...
        <Row className='m-0 p-0'>
          ...
          <Col className='m-0 p-0 px-3' xs={12} md={6}>
            <h6 style={{ color: '#595959' }}>How many years/months as an DDS?</h6>
            <Row className='m-0 p-0 mb-3'>
              <Col className='m-0 p-0 pe-0 pe-md-2' xs={12} md={6}>
                <TextField
                  size='small'
