...
const NoShowModal = ({ open, handleClose, selectedItem, fetchData }) => {
  ...
  const handleNoShow = () => {
    if (selectedItem !== null) {
      axios
        .put(
          `https://api.mddentalstaffing.com/api/v1/owner/applicants/${
            selectedItem.user_id
          }/not-show?cancel=${checked ? 1 : 0}
          `,
          null,
          {
            headers: {
            ...
            >
              ...
              <div>
                <FormControlLabel
                  ...
                  label={`Cancel all future assignments for `}
                  onChange={() => {
                    setChecked(!checked);
                  }}
                />
