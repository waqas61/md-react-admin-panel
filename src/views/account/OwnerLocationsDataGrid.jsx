      ...
      <Table className={classes.table}>
        ...
        <TableBody>
          {rows.map((item, index) => (
            ...
            >
              <TableCell className={classes.cell}>{item.place_name}</TableCell>
              ...
              <TableCell className={classes.cell}>
                {item.location_email ? item.location_email : '-'}
              </TableCell>
              <TableCell className={classes.cell}>
                {item.location_phone ? item.location_phone : '-'}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
...
export default withStyles(styles)(OwnerLocationsDataGrid);
